                        ...
                        if ($row['device_uid'] == $device_uid || $row['device_uid'] == 0){
                                ...
                                if (!mysqli_stmt_prepare($result, $sql)) {
                                    ...
                                    if (!$row = mysqli_fetch_assoc($resultl)){
                                        ...
                                        $sql = "INSERT INTO users_logs (username, serialnumber, card_uid, device_uid, device_dep, checkindate, timein, timeout, temp_degree) VALUES (? ,?, ?, ?, ?, ?, ?, ?, ?)";
                                        $result = mysqli_stmt_init($conn);
                                        if (!mysqli_stmt_prepare($result, $sql)) {
                                            ...
                                            $timeout = "00:00:00";
                                            mysqli_stmt_bind_param($result, "sdssssssd", $Uname, $Number, $card_uid, $device_uid, $device_dep, $d, $t, $timeout, $temp_degree);
                                            mysqli_stmt_execute($result);
